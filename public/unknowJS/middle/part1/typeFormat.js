...
console.info('Number("\\n") //', Number('\n'))
console.info('Object(null) //', Object(null))
console.info('Object(undefined) //', Object(undefined))
console.info('[null].toString() //', [null].toString())
console.info('String(null) //', String(null))

console.info('十三、 经验法则少出错')
console.info('1. 比较是否相等时，两边有boolean值或[]，不要用==')
console.info('2. 比较是否相等时，两边有""或0，保证左右类型相等')
console.info('3. 比较是否相等时，避免强制转换可以使用===')
